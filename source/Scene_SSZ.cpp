...
// Unique
const char LevelID = 0xC0;
// Modularized
Scene_SSZ::Scene_SSZ(Application* app, int act, int checkpoint) {
    SDL_RWops *_RWList[35] = {
        newFile(res_SSZ_level_lvl, "Resource/Stages/SSZ/level.lvl"),
        // Musics
        newFile(res_SSZ_act_1_ogg, "Resource/Stages/SSZ/Music/Act 1.ogg"),
        newFile(res_SSZ_act_2_ogg, "Resource/Stages/SSZ/Music/Act 2.ogg"),
        // Layouts
        newFile(res_SSZ_layout_1_bin, "Resource/Stages/SSZ/Data (Layout)/1.bin"), // Pre-Act
        newFile(res_SSZ_layout_1_bin, "Resource/Stages/SSZ/Data (Layout)/1.bin"), // Act 1
        newFile(res_SSZ_layout_2_bin, "Resource/Stages/SSZ/Data (Layout)/2.bin"),
        newFile(res_SSZ_layout_2_bin, "Resource/Stages/SSZ/Data (Layout)/2.bin"),
        // Chunks (128x128)
        newFile(res_SSZ_chunks_1_bin, "Resource/Stages/SSZ/Data (Chunks)/1.bin"), // Pre-Act
        newFile(res_SSZ_chunks_1_bin, "Resource/Stages/SSZ/Data (Chunks)/1.bin"), // Act 1
        newFile(res_SSZ_chunks_2_bin, "Resource/Stages/SSZ/Data (Chunks)/2.bin"),
        newFile(res_SSZ_chunks_2_bin, "Resource/Stages/SSZ/Data (Chunks)/2.bin"),
        // Tiles (16x16)
        newFile(res_SSZ_tiles_0_bin, "Resource/Stages/SSZ/Data (Tiles)/0.bin"), // Pre-Act
        newFile(res_SSZ_tiles_1_bin, "Resource/Stages/SSZ/Data (Tiles)/1.bin"), // Act 1
        newFile(res_SSZ_tiles_2_bin, "Resource/Stages/SSZ/Data (Tiles)/2.bin"),
        newFile(res_SSZ_tiles_2_bin, "Resource/Stages/SSZ/Data (Tiles)/2.bin"),
        // Rings
        newFile(res_SSZ_rings_2_bin, "Resource/Stages/SSZ/Data (Rings)/1.bin"), // Pre-Act
        newFile(res_SSZ_rings_1_bin, "Resource/Stages/SSZ/Data (Rings)/1.bin"), // Act 1
        newFile(res_SSZ_rings_2_bin, "Resource/Stages/SSZ/Data (Rings)/2.bin"),
        newFile(res_SSZ_rings_2_bin, "Resource/Stages/SSZ/Data (Rings)/2.bin"),
        // Objects
        newFile(res_SSZ_objects_1_bin, "Resource/Stages/SSZ/Data (Objects)/1.bin"), // Pre-Act
        newFile(res_SSZ_objects_1_bin, "Resource/Stages/SSZ/Data (Objects)/1.bin"), // Act 1
        newFile(res_SSZ_objects_2_bin, "Resource/Stages/SSZ/Data (Objects)/2.bin"),
        newFile(res_SSZ_objects_2_bin, "Resource/Stages/SSZ/Data (Objects)/2.bin"),
        // Palettes (Dry)
        newFile(res_SSZ_PAL1_DRY_png, "Resource/Stages/SSZ/Palettes/PAL1_DRY.png"), // Pre-Act
        newFile(res_SSZ_PAL1_DRY_png, "Resource/Stages/SSZ/Palettes/PAL1_DRY.png"), // Act 1
        newFile(res_SSZ_PAL2_DRY_png, "Resource/Stages/SSZ/Palettes/PAL2_DRY.png"),
        newFile(res_SSZ_PAL2_DRY_png, "Resource/Stages/SSZ/Palettes/PAL2_DRY.png"),
        // Palettes (Wet)
        newFile(res_SSZ_PAL1_WET_png, "Resource/Stages/SSZ/Palettes/PAL1_WET.png"), // Pre-Act
        newFile(res_SSZ_PAL1_WET_png, "Resource/Stages/SSZ/Palettes/PAL1_WET.png"), // Act 1
        newFile(res_SSZ_PAL2_WET_png, "Resource/Stages/SSZ/Palettes/PAL2_WET.png"),
        newFile(res_SSZ_PAL2_WET_png, "Resource/Stages/SSZ/Palettes/PAL2_WET.png"),
        // Palettes (Other)
        newFile(res_SSZ_PALm_DRY_png, "Resource/Stages/SSZ/Palettes/PAL1_DRY.png"), // Mini-boss
        newFile(res_SSZ_PALm_DRY_png, "Resource/Stages/SSZ/Palettes/PAL1_DRY.png"), // Boss
        newFile(res_SSZ_PALm_WET_png, "Resource/Stages/SSZ/Palettes/PAL1_WET.png"), // Extra 1 (Mini-boss)
        newFile(res_SSZ_PALm_WET_png, "Resource/Stages/SSZ/Palettes/PAL1_WET.png"), // Extra 2
    };
...
void Scene_SSZ::DoSwitchActZone() {
	if (!doSwitch) return;
	doSwitch = false;

    if (ActualAct == 2) {
        Scene_DEZ* nextLevel = new Scene_DEZ(App, 1, -1);
...
// Unique
void Scene_SSZ::InitZone(bool resetTextures, int check, int specialRing, bool actTransition) {
    int a = act & 0xF;

    if (a == 1)
        Tileset = new ITexture(IResources::Load("Stages/SSZ/Sprites/TILES1.png"), false);
    else if (a == 2)
        Tileset = new ITexture(IResources::Load("Stages/SSZ/Sprites/TILES2.png"), false);
...
void Scene_SSZ::CreateUniqueTextures(Application* app, int act) {
	unsigned int nextTick = SDL_GetTicks();

    T("SSZ") = new ITexture(IResources::Load("Stages/SSZ/Sprites/Texture.png"), false);



	App->print(0, "UNIQUE Texture load finished in %.3f seconds.", (SDL_GetTicks() - nextTick) / 1000.0f);
}
void Scene_SSZ::UnloadUniqueTextures(Application* app, int act) {

}

void Scene_SSZ::Update() {
    BGx = 1.f;
    BGy = 1.f / 4.f;
    BGstart = 0;
    BGsize = 4;
...
int Scene_SSZ::CustomAnimTile(int ind, int i, int parRow) {
...
// OVERRIDES
void Scene_SSZ::HandleCamera() {
	LevelScene::HandleCamera();

	if (MyPlayer->Action == ActionType::Dead)
		return;
}
void Scene_SSZ::DrawAboveEverythingNonHUD() {
	LevelScene::DrawAboveEverythingNonHUD();
    return;
}
void Scene_SSZ::Render() {
	LevelScene::Render();
}
void Scene_SSZ::Free() {
	LevelScene::Free();
