...
// Unique
const char LevelID = 0x80;
// Modularized
Scene_FBZ::Scene_FBZ(Application* app, int act, int checkpoint) {
    SDL_RWops *_RWList[35] = {
        ...
        newFile(res_FBZ_layout_2_bin, "Resource/Stages/FBZ/Data (Layout)/2.bin"),
        newFile(res_FBZ_layout_2_bin, "Resource/Stages/FBZ/Data (Layout)/2.bin"),
        // Chunks (128x128)
        newFile(res_FBZ_chunks_1_bin, "Resource/Stages/FBZ/Data (Chunks)/1.bin"), // Pre-Act
        newFile(res_FBZ_chunks_1_bin, "Resource/Stages/FBZ/Data (Chunks)/1.bin"), // Act 1
        newFile(res_FBZ_chunks_2_bin, "Resource/Stages/FBZ/Data (Chunks)/2.bin"),
        newFile(res_FBZ_chunks_2_bin, "Resource/Stages/FBZ/Data (Chunks)/2.bin"),
        // Tiles (16x16)
        newFile(res_FBZ_tiles_0_bin, "Resource/Stages/FBZ/Data (Tiles)/0.bin"), // Pre-Act
        newFile(res_FBZ_tiles_1_bin, "Resource/Stages/FBZ/Data (Tiles)/1.bin"), // Act 1
        newFile(res_FBZ_tiles_2_bin, "Resource/Stages/FBZ/Data (Tiles)/2.bin"),
        newFile(res_FBZ_tiles_2_bin, "Resource/Stages/FBZ/Data (Tiles)/2.bin"),
        // Rings
        newFile(res_FBZ_rings_2_bin, "Resource/Stages/FBZ/Data (Rings)/1.bin"), // Pre-Act
        newFile(res_FBZ_rings_1_bin, "Resource/Stages/FBZ/Data (Rings)/1.bin"), // Act 1
        newFile(res_FBZ_rings_2_bin, "Resource/Stages/FBZ/Data (Rings)/2.bin"),
        newFile(res_FBZ_rings_2_bin, "Resource/Stages/FBZ/Data (Rings)/2.bin"),
        // Objects
        newFile(res_FBZ_objects_1_bin, "Resource/Stages/FBZ/Data (Objects)/1.bin"), // Pre-Act
        newFile(res_FBZ_objects_1_bin, "Resource/Stages/FBZ/Data (Objects)/1.bin"), // Act 1
        newFile(res_FBZ_objects_2_bin, "Resource/Stages/FBZ/Data (Objects)/2.bin"),
        newFile(res_FBZ_objects_2_bin, "Resource/Stages/FBZ/Data (Objects)/2.bin"),
        // Palettes (Dry)
        newFile(res_FBZ_PAL1_DRY_png, "Resource/Stages/FBZ/Palettes/PAL1_DRY.png"), // Pre-Act
        newFile(res_FBZ_PAL1_DRY_png, "Resource/Stages/FBZ/Palettes/PAL1_DRY.png"), // Act 1
        newFile(res_FBZ_PAL2_DRY_png, "Resource/Stages/FBZ/Palettes/PAL2_DRY.png"),
        newFile(res_FBZ_PAL2_DRY_png, "Resource/Stages/FBZ/Palettes/PAL2_DRY.png"),
        // Palettes (Wet)
        newFile(res_FBZ_PAL1_WET_png, "Resource/Stages/FBZ/Palettes/PAL1_WET.png"), // Pre-Act
        newFile(res_FBZ_PAL1_WET_png, "Resource/Stages/FBZ/Palettes/PAL1_WET.png"), // Act 1
        newFile(res_FBZ_PAL2_WET_png, "Resource/Stages/FBZ/Palettes/PAL2_WET.png"),
        newFile(res_FBZ_PAL2_WET_png, "Resource/Stages/FBZ/Palettes/PAL2_WET.png"),
        // Palettes (Other)
        newFile(res_FBZ_PALm_DRY_png, "Resource/Stages/FBZ/Palettes/PAL1_DRY.png"), // Mini-boss
        newFile(res_FBZ_PALm_DRY_png, "Resource/Stages/FBZ/Palettes/PAL1_DRY.png"), // Boss
        newFile(res_FBZ_PALm_WET_png, "Resource/Stages/FBZ/Palettes/PAL1_DRY.png"), // Extra 1 (Mini-boss)
        newFile(res_FBZ_PALm_WET_png, "Resource/Stages/FBZ/Palettes/PAL1_DRY.png"), // Extra 2
    };
...
void Scene_FBZ::DoSwitchActZone() {
	if (!doSwitch) return;
	doSwitch = false;

    if (ActualAct == 2) {
        Scene_SOZ* nextLevel = new Scene_SOZ(App, 1, -1);
    ...
    int ObjectPlayerOffsetX = -0x2E00;
...
// Unique
void Scene_FBZ::InitZone(bool resetTextures, int check, int specialRing, bool actTransition) {
    int a = act & 0xF;

    if (a == 1)
        Tileset = new ITexture(IResources::Load("Stages/FBZ/Sprites/TILES1.png"), false);
    else if (a == 2)
        Tileset = new ITexture(IResources::Load("Stages/FBZ/Sprites/TILES2.png"), false);
...
void Scene_FBZ::CreateUniqueTextures(Application* app, int act) {
	unsigned int nextTick = SDL_GetTicks();

    T("FBZ") = new ITexture(IResources::Load("Stages/FBZ/Sprites/Texture.png"), false);



	App->print(0, "UNIQUE Texture load finished in %.3f seconds.", (SDL_GetTicks() - nextTick) / 1000.0f);
}
void Scene_FBZ::UnloadUniqueTextures(Application* app, int act) {

}

void Scene_FBZ::Update() {
    BGx = 1.f;
    BGy = 1.f / 4.f;
    BGstart = 0;
    BGsize = 4;
...
int Scene_FBZ::CustomAnimTile(int ind, int i, int parRow) {
...
// OVERRIDES
void Scene_FBZ::HandleCamera() {
	LevelScene::HandleCamera();

	if (MyPlayer->Action == ActionType::Dead)
		return;
}
void Scene_FBZ::DrawAboveEverythingNonHUD() {
	LevelScene::DrawAboveEverythingNonHUD();
    return;
}
void Scene_FBZ::Render() {
	LevelScene::Render();
}
void Scene_FBZ::Free() {
	LevelScene::Free();
