...
// Unique
const char LevelID = 0xA0;
// Modularized
Scene_LRZ::Scene_LRZ(Application* app, int act, int checkpoint) {
    SDL_RWops *_RWList[35] = {
        newFile(res_LRZ_level_lvl, "Resource/Stages/LRZ/level.lvl"),
        // Musics
        newFile(res_LRZ_act_1_ogg, "Resource/Stages/LRZ/Music/Act 1.ogg"),
        newFile(res_LRZ_act_2_ogg, "Resource/Stages/LRZ/Music/Act 2.ogg"),
        // Layouts
        newFile(res_LRZ_layout_1_bin, "Resource/Stages/LRZ/Data (Layout)/1.bin"), // Pre-Act
        newFile(res_LRZ_layout_1_bin, "Resource/Stages/LRZ/Data (Layout)/1.bin"), // Act 1
        newFile(res_LRZ_layout_2_bin, "Resource/Stages/LRZ/Data (Layout)/2.bin"),
        newFile(res_LRZ_layout_2_bin, "Resource/Stages/LRZ/Data (Layout)/2.bin"),
        // Chunks (128x128)
        newFile(res_LRZ_chunks_1_bin, "Resource/Stages/LRZ/Data (Chunks)/1.bin"), // Pre-Act
        newFile(res_LRZ_chunks_1_bin, "Resource/Stages/LRZ/Data (Chunks)/1.bin"), // Act 1
        newFile(res_LRZ_chunks_2_bin, "Resource/Stages/LRZ/Data (Chunks)/2.bin"),
        newFile(res_LRZ_chunks_2_bin, "Resource/Stages/LRZ/Data (Chunks)/2.bin"),
        // Tiles (16x16)
        newFile(res_LRZ_tiles_0_bin, "Resource/Stages/LRZ/Data (Tiles)/0.bin"), // Pre-Act
        newFile(res_LRZ_tiles_1_bin, "Resource/Stages/LRZ/Data (Tiles)/1.bin"), // Act 1
        newFile(res_LRZ_tiles_2_bin, "Resource/Stages/LRZ/Data (Tiles)/2.bin"),
        newFile(res_LRZ_tiles_2_bin, "Resource/Stages/LRZ/Data (Tiles)/2.bin"),
        // Rings
        newFile(res_LRZ_rings_2_bin, "Resource/Stages/LRZ/Data (Rings)/1.bin"), // Pre-Act
        newFile(res_LRZ_rings_1_bin, "Resource/Stages/LRZ/Data (Rings)/1.bin"), // Act 1
        newFile(res_LRZ_rings_2_bin, "Resource/Stages/LRZ/Data (Rings)/2.bin"),
        newFile(res_LRZ_rings_2_bin, "Resource/Stages/LRZ/Data (Rings)/2.bin"),
        // Objects
        newFile(res_LRZ_objects_1_bin, "Resource/Stages/LRZ/Data (Objects)/1.bin"), // Pre-Act
        newFile(res_LRZ_objects_1_bin, "Resource/Stages/LRZ/Data (Objects)/1.bin"), // Act 1
        newFile(res_LRZ_objects_2_bin, "Resource/Stages/LRZ/Data (Objects)/2.bin"),
        newFile(res_LRZ_objects_2_bin, "Resource/Stages/LRZ/Data (Objects)/2.bin"),
        // Palettes (Dry)
        newFile(res_LRZ_PAL1_DRY_png, "Resource/Stages/LRZ/Palettes/PAL1_DRY.png"), // Pre-Act
        newFile(res_LRZ_PAL1_DRY_png, "Resource/Stages/LRZ/Palettes/PAL1_DRY.png"), // Act 1
        newFile(res_LRZ_PAL2_DRY_png, "Resource/Stages/LRZ/Palettes/PAL2_DRY.png"),
        newFile(res_LRZ_PAL2_DRY_png, "Resource/Stages/LRZ/Palettes/PAL2_DRY.png"),
        // Palettes (Wet)
        newFile(res_LRZ_PAL1_WET_png, "Resource/Stages/LRZ/Palettes/PAL1_WET.png"), // Pre-Act
        newFile(res_LRZ_PAL1_WET_png, "Resource/Stages/LRZ/Palettes/PAL1_WET.png"), // Act 1
        newFile(res_LRZ_PAL2_WET_png, "Resource/Stages/LRZ/Palettes/PAL2_WET.png"),
        newFile(res_LRZ_PAL2_WET_png, "Resource/Stages/LRZ/Palettes/PAL2_WET.png"),
        // Palettes (Other)
        newFile(res_LRZ_PALm_DRY_png, "Resource/Stages/LRZ/Palettes/PAL1_DRY.png"), // Mini-boss
        newFile(res_LRZ_PALm_DRY_png, "Resource/Stages/LRZ/Palettes/PAL1_DRY.png"), // Boss
        newFile(res_LRZ_PALm_WET_png, "Resource/Stages/LRZ/Palettes/PAL1_WET.png"), // Extra 1 (Mini-boss)
        newFile(res_LRZ_PALm_WET_png, "Resource/Stages/LRZ/Palettes/PAL1_WET.png"), // Extra 2
    };
...
void Scene_LRZ::DoSwitchActZone() {
	if (!doSwitch) return;
	doSwitch = false;

    if (ActualAct == 2) {
        Scene_SSZ* nextLevel = new Scene_SSZ(App, 1, -1);
    ...
    int ObjectPlayerOffsetX = -0x2C00;
...
// Unique
void Scene_LRZ::InitZone(bool resetTextures, int check, int specialRing, bool actTransition) {
    int a = act & 0xF;

    if (a == 1)
        Tileset = new ITexture(IResources::Load("Stages/LRZ/Sprites/TILES1.png"), false);
    else if (a == 2)
        Tileset = new ITexture(IResources::Load("Stages/LRZ/Sprites/TILES2.png"), false);
...
void Scene_LRZ::CreateUniqueTextures(Application* app, int act) {
	unsigned int nextTick = SDL_GetTicks();

    T("LRZ") = new ITexture(IResources::Load("Stages/LRZ/Sprites/Texture.png"), false);



	App->print(0, "UNIQUE Texture load finished in %.3f seconds.", (SDL_GetTicks() - nextTick) / 1000.0f);
}
void Scene_LRZ::UnloadUniqueTextures(Application* app, int act) {

}

void Scene_LRZ::Update() {
    BGx = 1.f;
    BGy = 1.f / 4.f;
    BGstart = 0;
    BGsize = 4;
...
int Scene_LRZ::CustomAnimTile(int ind, int i, int parRow) {
...
// OVERRIDES
void Scene_LRZ::HandleCamera() {
	LevelScene::HandleCamera();

	if (MyPlayer->Action == ActionType::Dead)
		return;
}
void Scene_LRZ::DrawAboveEverythingNonHUD() {
	LevelScene::DrawAboveEverythingNonHUD();
    return;
}
void Scene_LRZ::Render() {
	LevelScene::Render();
}
void Scene_LRZ::Free() {
	LevelScene::Free();
