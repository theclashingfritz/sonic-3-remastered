...
// Unique
const char LevelID = 0xE0;
// Modularized
Scene_TDZ::Scene_TDZ(Application* app, int act, int checkpoint) {
    SDL_RWops *_RWList[35] = {
        newFile(res_TDZ_level_lvl, "Resource/Stages/TDZ/level.lvl"),
        // Musics
        newFile(res_TDZ_act_1_ogg, "Resource/Stages/TDZ/Music/Act_1.ogg"),
        newFile(res_TDZ_act_2_ogg, "Resource/Stages/TDZ/Music/Act_2.ogg"),
        // Layouts
        newFile(res_TDZ_layout_1_bin, "Resource/Stages/TDZ/Data (Layout)/1.bin"), // Pre-Act
        newFile(res_TDZ_layout_1_bin, "Resource/Stages/TDZ/Data (Layout)/1.bin"), // Act 1
        newFile(res_TDZ_layout_2_bin, "Resource/Stages/TDZ/Data (Layout)/2.bin"),
        newFile(res_TDZ_layout_2_bin, "Resource/Stages/TDZ/Data (Layout)/2.bin"),
        // Chunks (128x128)
        newFile(res_TDZ_chunks_1_bin, "Resource/Stages/TDZ/Data (Chunks)/1.bin"), // Pre-Act
        newFile(res_TDZ_chunks_1_bin, "Resource/Stages/TDZ/Data (Chunks)/1.bin"), // Act 1
        newFile(res_TDZ_chunks_2_bin, "Resource/Stages/TDZ/Data (Chunks)/2.bin"),
        newFile(res_TDZ_chunks_2_bin, "Resource/Stages/TDZ/Data (Chunks)/2.bin"),
        // Tiles (16x16)
        newFile(res_TDZ_tiles_0_bin, "Resource/Stages/TDZ/Data (Tiles)/0.bin"), // Pre-Act
        newFile(res_TDZ_tiles_1_bin, "Resource/Stages/TDZ/Data (Tiles)/1.bin"), // Act 1
        newFile(res_TDZ_tiles_2_bin, "Resource/Stages/TDZ/Data (Tiles)/2.bin"),
        newFile(res_TDZ_tiles_2_bin, "Resource/Stages/TDZ/Data (Tiles)/2.bin"),
        // Rings
        newFile(res_TDZ_rings_2_bin, "Resource/Stages/TDZ/Data (Rings)/1.bin"), // Pre-Act
        newFile(res_TDZ_rings_1_bin, "Resource/Stages/TDZ/Data (Rings)/1.bin"), // Act 1
        newFile(res_TDZ_rings_2_bin, "Resource/Stages/TDZ/Data (Rings)/2.bin"),
        newFile(res_TDZ_rings_2_bin, "Resource/Stages/TDZ/Data (Rings)/2.bin"),
        // Objects
        newFile(res_TDZ_objects_1_bin, "Resource/Stages/TDZ/Data (Objects)/1.bin"), // Pre-Act
        newFile(res_TDZ_objects_1_bin, "Resource/Stages/TDZ/Data (Objects)/1.bin"), // Act 1
        newFile(res_TDZ_objects_2_bin, "Resource/Stages/TDZ/Data (Objects)/2.bin"),
        newFile(res_TDZ_objects_2_bin, "Resource/Stages/TDZ/Data (Objects)/2.bin"),
        // Palettes (Dry)
        newFile(res_TDZ_PAL1_DRY_png, "Resource/Stages/TDZ/Palettes/PAL1_DRY.png"), // Pre-Act
        newFile(res_TDZ_PAL1_DRY_png, "Resource/Stages/TDZ/Palettes/PAL1_DRY.png"), // Act 1
        newFile(res_TDZ_PAL2_DRY_png, "Resource/Stages/TDZ/Palettes/PAL2_DRY.png"),
        newFile(res_TDZ_PAL2_DRY_png, "Resource/Stages/TDZ/Palettes/PAL2_DRY.png"),
        // Palettes (Wet)
        newFile(res_TDZ_PAL1_WET_png, "Resource/Stages/TDZ/Palettes/PAL1_WET.png"), // Pre-Act
        newFile(res_TDZ_PAL1_WET_png, "Resource/Stages/TDZ/Palettes/PAL1_WET.png"), // Act 1
        newFile(res_TDZ_PAL2_WET_png, "Resource/Stages/TDZ/Palettes/PAL2_WET.png"),
        newFile(res_TDZ_PAL2_WET_png, "Resource/Stages/TDZ/Palettes/PAL2_WET.png"),
        // Palettes (Other)
        newFile(res_TDZ_PALm_DRY_png, "Resource/Stages/TDZ/Palettes/PAL1_DRY.png"), // Mini-boss
        newFile(res_TDZ_PALm_DRY_png, "Resource/Stages/TDZ/Palettes/PAL1_DRY.png"), // Boss
        newFile(res_TDZ_PALm_WET_png, "Resource/Stages/TDZ/Palettes/PAL1_WET.png"), // Extra 1 (Mini-boss)
        newFile(res_TDZ_PALm_WET_png, "Resource/Stages/TDZ/Palettes/PAL1_WET.png"), // Extra 2
    };
...
void Scene_TDZ::DoSwitchActZone() {
	if (!doSwitch) return;
	doSwitch = false;
...
// Unique
void Scene_TDZ::InitZone(bool resetTextures, int check, int specialRing, bool actTransition) {
    int a = act & 0xF;

    if (a == 1)
        Tileset = new ITexture(IResources::Load("Stages/TDZ/Sprites/TILES1.png"), false);
    else if (a == 2)
        Tileset = new ITexture(IResources::Load("Stages/TDZ/Sprites/TILES2.png"), false);
...
void Scene_TDZ::CreateUniqueTextures(Application* app, int act) {
	unsigned int nextTick = SDL_GetTicks();

    T("TDZ") = new ITexture(IResources::Load("Stages/TDZ/Sprites/Texture.png"), false);



	App->print(0, "UNIQUE Texture load finished in %.3f seconds.", (SDL_GetTicks() - nextTick) / 1000.0f);
}
void Scene_TDZ::UnloadUniqueTextures(Application* app, int act) {

}

void Scene_TDZ::Update() {
    BGx = 1.f;
    BGy = 1.f / 4.f;
    BGstart = 0;
    BGsize = 4;
...
int Scene_TDZ::CustomAnimTile(int ind, int i, int parRow) {
...
// OVERRIDES
void Scene_TDZ::HandleCamera() {
	LevelScene::HandleCamera();

	if (MyPlayer->Action == ActionType::Dead)
		return;
}
void Scene_TDZ::DrawAboveEverythingNonHUD() {
	LevelScene::DrawAboveEverythingNonHUD();
    return;
}
void Scene_TDZ::Render() {
	LevelScene::Render();
}
void Scene_TDZ::Free() {
	LevelScene::Free();
